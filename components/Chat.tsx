                ...
                <div key={msg.id || Math.random()} className={`relative group flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                  ...
                  <div className="flex items-center space-x-2 group">
                    ...
                    {editingMessageId === msg.id ? (
                      <div className="flex flex-col space-y-2 bg-white p-3 rounded-2xl border border-indigo-100 shadow-md min-w-[200px]">
                        <textarea
                          className="w-full p-2 text-sm border-0 focus:ring-0 resize-none bg-slate-50 rounded-lg"
                          rows={2}
                          value={editValue}
